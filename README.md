...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pynu7ii.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pynu7ii.containers.anotherwebservice.com/
...
```
git clone git@github.com:codecrumbs404/container-pynu7ii.git
cd container-pynu7ii
```
...
```
docker attach container-pynu7ii
```
